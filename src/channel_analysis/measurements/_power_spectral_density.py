...
def power_spectral_density(
    ...
    *,
    ...
    isquantile = xp.array(isquantile)
    ...
    q = xp.asarray(frequency_statistic)[isquantile].astype(dtype)
    ...
    # everything else
    non_quantile_inds = np.where(~isquantile)[0]
    for i in non_quantile_inds:
