...
def time_fftshift(x, scale: Array | float | None = None, overwrite_x=False, axis=0):
    ...
    xview = axis_to_blocks(x, 2, axis=axis)
    outview = axis_to_blocks(out, 2, axis=axis)
...
def stft(
    ...
    *,
    ...
    if noverlap == 0:
        ...
        xstack = axis_to_blocks(x, nfft, axis=axis, truncate=truncate)
...
def oaresample(
    ...
    *,
    ...
    if filter_bandwidth is not None and isfinite(filter_bandwidth):
        y = _stft_fir_lowpass(
            y,
