...
def test_yaml_schema_binding():
    ...
    assert isinstance(spec.captures[0], sensor.bindings.air7201b.schema.capture), 'capture spec type'
    assert isinstance(spec.peripherals, sensor.bindings.air7201b.schema.peripherals), 'peripheral spec type'
    assert isinstance(spec.source, sensor.bindings.air7201b.schema.source), 'source spec type'
